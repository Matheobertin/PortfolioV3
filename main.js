...
function afficherProjet(projetId) {
    ...
    if (projet) {
        document.getElementById('projet_info').innerHTML = `<h2>${projet.title}</h2><p>${projet.description}</p><p>${projet.conclusion}</p><img src="${projet.img}"><a href="${projet.lien}"target="_blank">Link</a>`;
